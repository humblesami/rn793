import alien_icon from './ts_files/alien_icon';
import bank2_icon from './ts_files/bank2_icon';
import category_icon from './ts_files/category_icon';
import delete_icon from './ts_files/delete_icon';
...
import trash_icon from './ts_files/trash_icon';

export const SvgIcons = {
  'alien_icon': { svg: alien_icon, name: 'ALIEN' },
  'bank2_icon': { svg: bank2_icon, name: 'BANK2' },
  'category_icon': { svg: category_icon, name: 'CATEGORY' },
  'delete_icon': { svg: delete_icon, name: 'DELETE' },
  ...
  'trash_icon': { svg: trash_icon, name: 'TRASH' },
};
